...
#define AI_LSTM_MODEL_SIGNATURE     "d467de8f38f9b2d3c9bfba06d99d95de"
...
#define AI_TOOLS_DATE_TIME   "Thu Oct  6 20:18:38 2022"
...
/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_output0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 40, AI_STATIC)
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  dense_24_dense_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 4, AI_STATIC)
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_kernel_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 120, AI_STATIC)
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_recurrent_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 400, AI_STATIC)
/* Array#5 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_peephole_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 30, AI_STATIC)
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 40, AI_STATIC)
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#9 */
AI_ARRAY_OBJ_DECLARE(
  lstm_24_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Tensor #1 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_output0, AI_STATIC,
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 1, 4), AI_STRIDE_INIT(4, 4, 4, 40, 40),
  1, &lstm_24_output0_array, NULL)
...
/* Tensor #3 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_kernel, AI_STATIC,
  3, 0x0,
  AI_SHAPE_INIT(4, 3, 1, 1, 40), AI_STRIDE_INIT(4, 4, 4, 160, 160),
  1, &lstm_24_kernel_array, NULL)

/* Tensor #4 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_recurrent, AI_STATIC,
  4, 0x0,
  AI_SHAPE_INIT(4, 10, 1, 1, 40), AI_STRIDE_INIT(4, 4, 4, 160, 160),
  1, &lstm_24_recurrent_array, NULL)

/* Tensor #5 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_peephole, AI_STATIC,
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 30, 1, 1), AI_STRIDE_INIT(4, 4, 4, 120, 120),
  1, &lstm_24_peephole_array, NULL)

/* Tensor #6 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_bias, AI_STATIC,
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 40, 1, 1), AI_STRIDE_INIT(4, 4, 4, 160, 160),
  1, &lstm_24_bias_array, NULL)
...
/* Tensor #9 */
AI_TENSOR_OBJ_DECLARE(
  lstm_24_scratch0, AI_STATIC,
  9, 0x0,
  AI_SHAPE_INIT(4, 1, 70, 1, 1), AI_STRIDE_INIT(4, 4, 4, 280, 280),
  1, &lstm_24_scratch0_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &lstm_24_output0),
...
AI_LAYER_OBJ_DECLARE(
  dense_24_dense_layer, 1,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &dense_24_dense_chain,
  NULL, &dense_24_dense_layer, AI_STATIC, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  lstm_24_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &lstm_24_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 9, &lstm_24_kernel, &lstm_24_recurrent, &lstm_24_peephole, &lstm_24_bias, NULL, NULL, NULL, NULL, NULL),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &lstm_24_scratch0)
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2404, 1, 1),
    2404, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 488, 1, 1),
    488, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_LSTM_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_LSTM_OUT_NUM, &dense_24_dense_output),
  &lstm_24_layer, 0, NULL)
