...
#define AI_LSTM_ORIGIN_MODEL_NAME   "model_54"
...
#define AI_LSTM_IN_1_HEIGHT      (4)
#define AI_LSTM_IN_1_CHANNEL     (3)
#define AI_LSTM_IN_1_SIZE        (4 * 3)
#define AI_LSTM_IN_1_SIZE_BYTES  (48)
...
#define AI_LSTM_OUT_1_HEIGHT      (4)
#define AI_LSTM_OUT_1_CHANNEL     (1)
#define AI_LSTM_OUT_1_SIZE        (4 * 1)
#define AI_LSTM_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_LSTM_N_NODES (2)
